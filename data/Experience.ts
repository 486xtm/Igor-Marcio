...
export const ExperienceData = [
  {
    ...
    img: '/company-logo/medsure.png',
    organization: "MedSure Systems",
    location: 'Remote',
    description: [
  ...
  },
  {
    id: 3,
    type: MilestoneTypes.Work,
    date: '06/2016 - 04/2019',
    title: 'Full Stack Developer',
    img: '/company-logo/divisico.png',
  ...
  },
  {
    ...
    img: '/company-logo/bel.jpg',
    organization: 'BelmopanCityOnline.com',
    location: 'Hybrid',
    description: [
  ...
  },
  {
    ...
    img: '/company-logo/belize.png',
    organization: 'University of Belize',
    location: 'Belize, Brazil',
    // gpa: 3.8,
    description: [
